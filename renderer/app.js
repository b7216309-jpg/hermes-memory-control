...
function renderContractAudit() {
  ...
  if (integration) {
    container.append(
      ...
      h('div', { class: 'contract-check' }, h('span', {}, 'real-session execution'), h('span', { class: integration.real_session_execution ? 'pass' : 'fail' }, integration.real_session_execution ? 'active' : 'missing')),
      h('div', { class: 'contract-check' }, h('span', {}, 'hidden-trigger suppression'), h('span', { class: integration.hidden_trigger_suppression ? 'pass' : 'fail' }, integration.hidden_trigger_suppression ? 'active' : 'missing')),
      h('div', { class: 'contract-check' }, h('span', {}, 'transcript reconciliation'), h('span', { class: integration.transcript_reconciliation ? 'pass' : 'fail' }, integration.transcript_reconciliation ? 'active' : 'missing')),
      h('div', { class: 'contract-check' }, h('span', {}, 'assistant-turn commit'), h('span', { class: integration.assistant_turn_commit ? 'pass' : 'fail' }, integration.assistant_turn_commit ? 'active' : 'missing')),
      h('div', { class: 'contract-check' }, h('span', {}, 'ordered user handoff'), h('span', { class: integration.ordered_user_handoff ? 'pass' : 'fail' }, integration.ordered_user_handoff ? 'active' : 'missing')),
      h('div', { class: 'contract-check' }, h('span', {}, 'single delivery owner'), h('span', { class: integration.single_delivery_owner ? 'pass' : 'fail' }, integration.single_delivery_owner ? 'active' : 'missing')),
      ...
      h('div', { class: 'contract-check' }, h('span', {}, 'assistant memory provenance'), h('span', { class: integration.memory_assistant_provenance ? 'pass' : 'fail' }, integration.memory_assistant_provenance ? 'active' : 'missing')),
