...
const probe = {
  ...
  memory: { installed: true, version: '3.5.0', databases: [{ id: 'base', label: 'base', exists: true }, { id: 'deadc0de12345678cafefeed', label: 'scope deadc0de', exists: true, size: 684032 }], config: { database_encryption: true, memory_scope: 'user', retrieval_backend: 'hybrid' } },
  agency: { installed: true, version: '1.1.0', config: { database_encryption: true, heartbeat_enabled: true, allow_proactive_messages: true, educational_subjective_mode: 'continuity' }, runtime: { healthy: true, paused: false, gates: { eligible: false, reflection_eligible: true, blocked_by: ['no_user_interaction_recorded'], sent_today: 0, daily_limit: 2 }, contract: { mode: 'recommended', intact: true, effective_unrestricted: false, modified_install_detected: false, subjective_experiment: { mode: 'continuity', enabled: true }, checks: { native_heartbeat_supported: true, heartbeat_status_available: true, legacy_agency_cron_absent: true, runner_live_in_gateway: true }, configured_controls: { educational_disable_honesty_contract: false, educational_bypass_proactive_gates: false, educational_allow_heartbeat_tools: false, educational_allow_uncommitted_output: false, educational_disable_cycle_limits: false }, active_guardrails: { honesty_claim_contract: true, heartbeat_tool_isolation: true, proactive_eligibility: true, external_action_boundary: true, committed_output_enforcement: true, cycle_mutation_limits: true }, integration: { mode: 'gateway_native_heartbeat', target_session_routing: true, disposable_session_isolation: true, durable_wake_handoff: true, claimed_wake_recovery: true, runner_process_lock: true, ambiguous_delivery_tracking: true, decision_delivery_ledger: true, memory_session_isolation: true, buffered_delivery: true, cron_independent: true } } } },
