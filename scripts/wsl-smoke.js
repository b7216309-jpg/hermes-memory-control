...
async function main() {
  ...
  assert.equal(probe.agency.runtime.contract.integration.real_session_execution, true);
  assert.equal(probe.agency.runtime.contract.integration.hidden_trigger_suppression, true);
  assert.equal(probe.agency.runtime.contract.integration.transcript_reconciliation, true);
  assert.equal(probe.agency.runtime.contract.integration.assistant_turn_commit, true);
  assert.equal(probe.agency.runtime.contract.integration.ordered_user_handoff, true);
  assert.equal(probe.agency.runtime.contract.integration.single_delivery_owner, true);
  ...
  assert.equal(probe.agency.runtime.contract.integration.memory_assistant_provenance, true);
